...
public abstract class RobotType {
    ...
    protected double x, y, currentAngle, width, length;
    protected Telemetry telemetry;

    public RobotType (double x, double y, double currentAngle, double width, double length) {
        ...
        this.currentAngle = currentAngle;     //Unit is degrees for humans and radians for calculations, point (0, 0) to (180, 0) is 0 degrees, (0, 0) to (0, 180) is 90 degrees
